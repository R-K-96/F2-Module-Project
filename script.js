    ...
    students.forEach((student) => {
        ...
        keys.forEach((key) => {
            if (key == 'ID') {
                ...
                degree.innerHTML = `<div class="icons"> ${student[key]} <div class="icons-logo" ><span onClick="edit(${student['ID']})" class="material-icons">
                edit
                </span><span onClick="del(${student['ID']})" class="material-icons">
                delete
                </span></div> </div>`;
...
function edit(id) {
    students.forEach((student) => {
        if (student['ID'] == id) {
            ...
            document.getElementById('submit').style.border='1px solid gray';
            document.getElementById('submit').style.fontWeight='100';
            document.getElementById('submit').style.fontSize='12px'
